...
#Core Cluster Identification, clustering method: spectral clustering
...
Correspondence=clusterCorrespondence(clustering.base, overallbase.clustering)
clusternew = Correspondence[clustering.base]
...
clustercore=c(rep(1,length(un1)),rep(2,length(un2)), rep(3,length(un3)),rep(4,length(un4)),rep(5,length(un5)),rep(6,length(un6)),rep(7,length(un7)))
data.core= data.core%>% mutate(clustercore=clustercore)

#Figures

#Plot core clusters in 12C/13C and 14N/15N plot
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig5g.pdf",family="Helvetica")
coordProj(data.core[c(5:6)], what="classification",classification=clustercore,col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C"),symbols=c(20,17,4,9,18,0,1), log ="xy", xaxt='n',  yaxt='n', ann=F, xlim=c(1,10^4),ylim=c(1,20000))
...
text(3000,550,label="Solar", col="black",cex=1.4)
text(4000,330,label="Terrestrial", col="black",cex=1.4)
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig5h.pdf",family="Helvetica")
coordProj(data.core[c(8:7)], what="classification",classification=clustercore,col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C"),symbols=c(20,17,4,9,18,0,1), xaxt='n',  yaxt='n', ann=F, xlim=c(-800,900),ylim=c(-700,600))
legend("topright", c("1","2","3","4","5","6","7"),col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C"),pch=c(20,17,4,9,18,0,1),cex=1.2, pt.cex=1)
...
Type[Type=="M"]="MS"
Type2=Type[M.core]
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig5i.pdf",family="Helvetica", width=10.5, height=10.5)
