...
#BagClust 1, Mixture of normal distributions with nine clusters
...
clusteringB2=base$classification
...
for (i in 1:B){
	...
	sc=Mclust(newdata[c(9:12)],model="VVV",G=ncluster)
	clusteringA=sc$classification
	IN[i,newdata$ID2]= 1
...
# Cluster labels from overallbase.clustering matched to clusternew 
Correspondence2
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8a.pdf",family="Helvetica")
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8b.pdf",family="Helvetica")
...
#Bar plot
Type[Type=="M"]="MS"
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8c.pdf",family="Helvetica",width=10.5, height=10.5)
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8d.pdf",family="Helvetica")
coordProj(d.stabil[c(5:6)], what="classification",classification=clusternew[which(CV>=0.90)],col=c("#A6CEE3", "#E31A1C", "#B15928","#1F78B4","#33A02C", "#CAB2D6"),symbols=c(20,17,18,0,1,3), log ="xy", xaxt='n',  yaxt='n', ann=F,xlim=c(1,10^4),ylim=c(1,20000))
legend("topright", c("1","2","5","6","7","8"),col=c("#A6CEE3", "#E31A1C", "#B15928","#1F78B4","#33A02C", "#CAB2D6"),pch=c(20,17,18,0,1,3),cex=1.2, pt.cex=1)
axis(1, at = c(10^0, 10^1, 10^2, 10^3, 10^4),
     c(expression(10^0),expression(10^1),expression(10^2),
       expression(10^3), expression(10^4)), cex.lab=1.5, cex.axis=1.5)
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8e.pdf",family="Helvetica")
coordProj(d.stabil[c(8:7)], what="classification",classification=clusternew[which(CV>=0.90)],col=c("#A6CEE3", "#E31A1C", "#B15928","#1F78B4","#33A02C", "#CAB2D6"),symbols=c(20,17,18,0,1,3) ,xaxt='n',  yaxt='n', ann=F, xlim=c(-800,900),ylim=c(-700,600))
legend("topright", c("1","2","5","6","7","8"),col=c("#A6CEE3", "#E31A1C", "#B15928","#1F78B4","#33A02C", "#CAB2D6"),pch=c(20,17,18,0,1,3),cex=1.2, pt.cex=1)
axis(1, at = c(-800,-600,-400,-200, 0, 200, 400,600,800), cex.lab=1.5, cex.axis=1.5)
axis(2, at = c(-800,-600,-400,-200,0,200,400,600,800),cex.lab=1.5, cex.axis=1.5)
title(xlab=expression(paste(delta, "("^{30}, "Si/"^{28}, "Si)(\u2030)") ),line=2.8, cex.lab=1.7)
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig8f.pdf",family="Helvetica", width=10.5, height=10.5)
...
scale_fill_manual(values=c("#A6CEE3", "#CAB2D6", "#6A3D9A", "#1F78B4", "#B15928", "#33A02C"))+
coord_cartesian(ylim=c(0,575))+
geom_text(x=0.65, y=570, label="(f)",size=11)+
labs(x="Cluster",fill="Grain Type")+
theme_classic()+
theme(aspect.ratio = 1,
        axis.text = element_text(size=30),
...
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig9g.pdf",family="Helvetica")
coordProj(data3[c(5:6)], what="classification",classification=clusternew,col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C", "#CAB2D6","#FB9A99"),symbols=c(20,17,4,9,18,0,1,3,5), log ="xy", xaxt='n',  yaxt='n', ann=F,xlim=c(20, 400),ylim=c(100,20000))
legend("topright", c("1","2","3","4","5","6","7","8","9"),col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C", "#CAB2D6","#FB9A99"),pch=c(20,17,4,9,18,0,1,3,5),cex=1.2, pt.cex=1)
...
text(20,18500,label="(g)", col="black",cex=1.8)
dev.off()

#Zoomed Clusters in 29Si/28Si and 30Si/28Si plot
pdf("C:/Users/ghystad/Documents/Clustering/SiC_clustering/Publication_MNRAS/Figures_ready/fig9h.pdf",family="Helvetica")
coordProj(data3[c(8:7)], what="classification",classification=clusternew,col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C", "#CAB2D6","#FB9A99"),symbols=c(20,17,4,9,18,0,1,3,5), xaxt='n',  yaxt='n', ann=F, xlim=c(-100,280),ylim=c(-100,200))
legend("topright", c("1","2","3","4","5","6","7","8","9"),col=c("#A6CEE3", "#E31A1C", "#6A3D9A","#FF7F00", "#B15928","#1F78B4","#33A02C", "#CAB2D6","#FB9A99"), pch=c(20,17,4,9,18,0,1,3,5),cex=1.2, pt.cex=1)
...
text(-100,195,label="(h)", col="black",cex=1.8)
dev.off()
